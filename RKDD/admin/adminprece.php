...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($bilde["tmp_name"], $mērķaFails)) {
        ...
        // Perform database insertion with the retrieved data
        $insertSql = "INSERT INTO produkts (nosaukums, apraksts, cena, veids, skruves, attalums, bilde) VALUES ('$nosaukums', '$apraksts', '$cena', '$veids', '$skruves', '$attalums', '$mērķaFails')";
